...
export async function systemRoute(app: FastifyInstance): Promise<void> {
  app.get('/api/system/status', async (request) => {
    ...
    return {
      ok: true,
      version: '4.9.0',
      mode: 'voice-provider-readiness-for-single-gateway-pilot-no-paid-llm',
      ...
      protectedPages: ['/admin', '/admin-app', '/voice-provider-readiness', '/telephony-setup', '/client-profile-builder', '/client-editor', '/client-activity', '/client-onboarding-pack', '/call-leads', '/production-checklist', '/voice-webhook-test', '/unknown-questions', '/website-import', '/weaknesses', '/clients', '/onboarding', '/tts-test'],
      businessSlug,
