...
export async function systemRoute(app: FastifyInstance): Promise<void> {
  app.get('/api/system/status', async (request) => {
    ...
    return {
      ...
      protectedPages: ['/admin', '/telephony-setup', '/client-profile-builder', '/client-editor', '/client-activity', '/client-onboarding-pack', '/call-leads', '/production-checklist', '/voice-webhook-test', '/unknown-questions', '/website-import', '/weaknesses', '/clients', '/onboarding', '/tts-test'],
      businessSlug,
