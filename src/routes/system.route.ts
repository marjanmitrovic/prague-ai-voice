...
export async function systemRoute(app: FastifyInstance): Promise<void> {
  app.get('/api/system/status', async (request) => {
    ...
    return {
      ok: true,
      version: '4.8.0',
      mode: 'admin-pwa-for-mobile-admin-workflow-no-paid-llm',
      ...
      protectedPages: ['/admin', '/admin-app', '/telephony-setup', '/client-profile-builder', '/client-editor', '/client-activity', '/client-onboarding-pack', '/call-leads', '/production-checklist', '/voice-webhook-test', '/unknown-questions', '/website-import', '/weaknesses', '/clients', '/onboarding', '/tts-test'],
      businessSlug,
