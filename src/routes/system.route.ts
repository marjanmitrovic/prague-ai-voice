...
export async function systemRoute(app: FastifyInstance): Promise<void> {
  app.get('/api/system/status', async (request) => {
    ...
    return {
      ok: true,
      version: '4.6.0',
      mode: 'client-activity-log-and-delete-protected-editor-no-paid-llm',
      ...
      protectedPages: ['/admin', '/client-profile-builder', '/client-editor', '/client-activity', '/client-onboarding-pack', '/call-leads', '/production-checklist', '/voice-webhook-test', '/unknown-questions', '/website-import', '/weaknesses', '/clients', '/onboarding', '/tts-test'],
      businessSlug,
