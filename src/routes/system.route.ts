...
export async function systemRoute(app: FastifyInstance): Promise<void> {
  app.get('/api/system/status', async (request) => {
    ...
    return {
      ok: true,
      version: '5.2.0',
      mode: 'simple-admin-mode-client-focused-no-paid-llm',
      storage: storageInfo.mode,
      databaseUrlConfigured: storageInfo.databaseUrlConfigured,
      simpleAdminMode: true,
      simplifiedAdminDashboard: true,
      simplifiedMobileAdmin: true,
      advancedToolsCollapsed: true,
      mainAdminActions: ['callLeads', 'clients', 'telephonySetup'],
      adminPwa: '/admin-app',
      adminPwaReady: true,
      adminPwaManifest: '/admin.webmanifest',
      adminServiceWorker: '/admin-sw.js',
      adminServiceWorkerCacheVersion: '5.2.0',
      ...
      voiceProviderReadiness: '/voice-provider-readiness',
      voiceProviderReadinessReady: true,
      voiceProviderChecklistMode: 'single-voice-gateway-provider-readiness',
      ...
      clientActivityLog: '/client-activity',
      clientActivityApi: '/api/client-activity',
      clientActivityLogReady: true,
      clientEditorBackupBeforeSave: true,
      clientBackupRestore: true,
      clientDeleteProtection: true,
      deleteEndpoint: '/api/business-profile',
      protectedDemoSlugs: ['studio-aurora', 'barber-nova'],
      backupEndpoint: '/api/system/backup.json',
      restoreEndpoint: '/api/business-profile/restore',
      ...
      protectedPages: ['/admin', '/admin-app', '/voice-provider-readiness', '/telephony-setup', '/client-profile-builder', '/client-editor', '/client-activity', '/client-onboarding-pack', '/clients', '/call-leads', '/production-checklist', '/voice-webhook-test', '/unknown-questions', '/website-import', '/weaknesses', '/onboarding', '/tts-test'],
      businessSlug,
      ...
      checks: {
        ...
        voiceProviderReadiness: true,
        voiceProviderChecklist: true,
