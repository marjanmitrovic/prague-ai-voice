...
## Test slabých míst bez LLM

Verze 2.0.0 přidává stránku `/weaknesses`, kde lze testovat otázky zákazníků, měřit fallback odpovědi a doplňovat ručně ověřenou FAQ znalostní bázi. Viz `docs/NO_LLM_WEAKNESS_TESTING.md`.
